...
public class PayDemoActivity extends FragmentActivity {
	...
	// 商户私钥，pkcs8格式//正式软件时 不能写在这  ，加密----》传给支付宝，支付宝使用咱们上传的公钥进行解密
	...
	private TextView product_price,product_describe,product_subject;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		product_price.setText(mPrice);
		product_subject.setText(mSubject);
		product_describe.setText(mDescribe);
	}
	...
	public void pay(View v) {
		...
		if(!TextUtils.isEmpty(mDescribe)&&!TextUtils.isEmpty(mSubject)&&!TextUtils.isEmpty(mPrice)){
			orderInfo = getOrderInfo(mSubject, mDescribe, mPrice);
		}else{
