...
public class VerticalScrollTv extends TextView {
    ...
    public int index = 0;
    private List<Surging_Hottest> list;
    ...
    public VerticalScrollTv(Context context, AttributeSet attr) {
        super(context, attr);
        init();
    }
    public VerticalScrollTv(Context context, AttributeSet attr, int i) {
    ...
    private void init() {
        setFocusable(true);
        if(list==null){
            list=new ArrayList<Surging_Hottest>();
            Surging_Hottest sen=new Surging_Hottest();
            list.add(0, sen);
        }
    ...
    public List<Surging_Hottest> getList() {
        return list;
    }

    public void setList(List<Surging_Hottest> list) {
        this.list = list;
    }
