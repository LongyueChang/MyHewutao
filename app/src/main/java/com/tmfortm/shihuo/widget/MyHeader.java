...
public class MyHeader extends RelativeLayout {
    ...
    /**
     * Inflates layout from <code>xml</code> and encapsulates it with <code>MyHeader</code>.
     *
     * @param context   application context.
     * @param layoutRes layout resource to be inflated.
     * @return <code>MyHeader</code> view object.
     */
    public static MyHeader fromXml(Context context, @LayoutRes int layoutRes) {
    ...
    /**
     * Attaches <code>MyHeader</code> to <code>RecyclerView</code>.
     ...
     *
     * @param recycler <code>RecyclerView</code> to attach <code>MyHeader</code> to.
     */
     ...
     *                             that user has already aligned <code>MyHeader</code> properly.
     */
    ...
    private void setupAlignment(RecyclerView recycler) {
        if (!mAlreadyAligned) {
            ...
            MyHeader.this.setLayoutParams(newHeaderParams);
            ...
            if (currentParent instanceof ViewGroup) {
                ...
                newRootParent.addView(MyHeader.this);
    ...
    private void setupHeader(final RecyclerView recycler) {
        recycler.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                mCurrentScroll += dy;
                MyHeader.this.setTranslationY(-mCurrentScroll);
            }
        });

        MyHeader.this.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            @Override
            public void onGlobalLayout() {
                int height = MyHeader.this.getHeight();
                if (height > 0) {
                    if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.JELLY_BEAN) {
                        MyHeader.this.getViewTreeObserver().removeOnGlobalLayoutListener(this);
                    } else {
                        MyHeader.this.getViewTreeObserver().removeGlobalOnLayoutListener(this);
                    }
    ...
    private void validateRecycler(RecyclerView recycler, boolean headerAlreadyAligned) {
        ...
        if (layoutManager == null) {
            throw new IllegalStateException("Be sure to call MyHeader constructor after setting your RecyclerView's LayoutManager.");
            ...
            throw new IllegalArgumentException("Currently MyHeader supports only LinearLayoutManager, GridLayoutManager and StaggeredGridLayoutManager.");
        }

        if (layoutManager instanceof LinearLayoutManager) {
            if (((LinearLayoutManager) layoutManager).getOrientation() != LinearLayoutManager.VERTICAL) {
                throw new IllegalArgumentException("Currently MyHeader supports only VERTICAL orientation LayoutManagers.");
            }
        } else if (layoutManager instanceof StaggeredGridLayoutManager) {
            if (((StaggeredGridLayoutManager) layoutManager).getOrientation() != StaggeredGridLayoutManager.VERTICAL) {
                throw new IllegalArgumentException("Currently MyHeader supports only VERTICAL orientation StaggeredGridLayoutManagers.");
            }
        }
        ...
        if (!headerAlreadyAligned) {
            ...
            if (parent != null &&
                ...
                throw new IllegalStateException("Currently, NOT already aligned MyHeader " +
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        if (mRecyclerWantsTouchEvent && ev.getAction() == MotionEvent.ACTION_MOVE) {
